            ...
            <div class="card">
                <div class="row">
                    ...
                    <div class="col" style="padding: 20px;">
                        <br>
                        <h1 class="fw-bold mb-2 text-uppercase" style="text-align: center; font-size: 30px;">VEUILLEZ VOUS CONNECTER À VOTRE COMPTE</h1>
                        ...
                        <form @submit.prevent="loginUser">
                            ...
                            <p class="mb-5 pb-lg-2" style="color: #393f81;">Vous n'avez pas de compte ? <a href="/signin"
